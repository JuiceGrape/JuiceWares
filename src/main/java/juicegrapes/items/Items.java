...
public class Items {
	...
	public static void init() {
		...
		nightvisiongoggles = new juicegrapes.items.NightVisionGoggles(ItemInfo.GOGGLES_ID, EnumArmorMaterial.IRON, juicewares.proxy.addArmor("Goggles"), 0);
		GameRegistry.registerItem(nightvisiongoggles, ItemInfo.GOGGLES_KEY);
		
		debugitem = new juicegrapes.items.DebugItem(ItemInfo.DEBUG_ID);
		GameRegistry.registerItem(debugitem, ItemInfo.DEBUG_KEY);
		
		lens = new juicegrapes.items.ItemLens(ItemInfo.LENS_ID);
